<template>
  <div class="nav">
    <div class="nav-content">
      <div class="name-item">
        <div class="sedra-name">
          Sedra_Rabe
        </div>
      </div>
      <div class="menu">
        <div class="menu-item">
          <a href="#" @click="scrollToSection('#home')">Acceuil</a>
          <a href="#" @click="scrollToSection('#info')">A propos</a>
...
.sedra-name {
  ...
  background: linear-gradient(94.52deg, #F5F5F5 20.79%, #BFBFBF 91.13%);
